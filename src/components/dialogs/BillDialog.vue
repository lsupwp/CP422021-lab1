        ...
        <VCard>
            ...
            <VCardText>
                ...
                <VTable>
                    <tbody>
                        <tr>
                            <td class="text-h6">รายการทั้งหทด</td>
                            <td class="text-right">{{ props.table.foods.length }} รายการ</td>
                        </tr>
                        <tr class="text-h5">
                            <td>ยอดรวมทั้งหมด</td>
            ...
            <VCardActions class="justify-center mb-5">
                <VBtn @click="dialogVisible = false" class="mx-2 px-2"
                    variant="elevated" color="error">
                    ยกเลิก
                </VBtn>
                <VBtn @click="onBill" class="mx-2 px-2" variant="elevated" color="primary">
                    ชำระเงิน
                </VBtn>
            </VCardActions>
        </VCard>
